...
export function Inventory() {
  ...
  return (
    <div className="inventory-container animate-fade-in-up">
      <div className="inventory-header">
        <h1 className="inventory-title">CATÁLOGO</h1>
        <p className="inventory-subtitle">{filteredProducts.length} productos disponibles</p>
      </div>
      ...
      {filteredProducts.length === 0 && (
        <div className="no-results">No hay productos que coincidan con tu búsqueda</div>
      )}
    </div>
  )
}
